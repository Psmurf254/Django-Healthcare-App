...
SECRET_KEY = os.environ.get("SECRET_KEY", default='+5$wkduvx4vaesp(far#d^l)&_w&^(t=&qtmc%s^m-sc&fh9pd')
...
ALLOWED_HOSTS = ["quicksuite.quickfiber.co.ke", "quickfiber.co.ke","0.0.0.0", "127.0.0.1"]
...
CSRF_TRUSTED_ORIGINS = [
    "https://quicksuite.quickfiber.co.ke",
    "https://quickhost.quickfiber.ke",
]
...
APPOINTMENT_WEBSITE_NAME = 'Quick Appointments'
# Your stuff...
# ------------------------------------------------------------------------------
