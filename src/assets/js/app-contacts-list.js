...
$(function () {
  ...
  var dt_contact_table = $('.datatables-contacts'),
    select2 = $('.select2'),
    contactView = '/app/contact/view/account/',
    statusObj = {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              '<div class="d-flex justify-content-start align-items-center contact-name">' +
        ...
        //     var roleBadgeObj = {
        //       Subscriber:
        //         '<span class="badge badge-center rounded-pill bg-label-warning w-px-30 h-px-30 me-2"><i class="ti ti-contact ti-sm"></i></span>',
        //       Author:
                ...
                format: {
                  body: function (inner, coldex, rowdex) {
                    ...
                    $.each(el, function (index, item) {
                      if (item.classList !== undefined && item.classList.contains('contact-name')) {
