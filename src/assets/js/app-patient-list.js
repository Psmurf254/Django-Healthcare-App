...
$(function () {
  ...
  var dt_patient_table = $('.datatables-patients'),
    select2 = $('.select2'),
    patientView = '/app/patient/view/account/',
    statusObj = {
  ...
  // patients datatable
  if (dt_patient_table.length) {
    var dt_patient = dt_patient_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              '<div class="d-flex justify-content-start align-items-center patient-name">' +
        ...
        //     var roleBadgeObj = {
        //       Subscriber:
        //         '<span class="badge badge-center rounded-pill bg-label-warning w-px-30 h-px-30 me-2"><i class="ti ti-patient ti-sm"></i></span>',
        //       Author:
      ...
      buttons: [
                ...
                format: {
                  body: function (inner, coldex, rowdex) {
                    ...
                    $.each(el, function (index, item) {
                      if (item.classList !== undefined && item.classList.contains('patient-name')) {
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New Patient</span>',
  ...
  // Delete Record
  $('.datatables-patients tbody').on('click', '.delete-record', function () {
    dt_patient.row($(this).parents('tr')).remove().draw();
  });
