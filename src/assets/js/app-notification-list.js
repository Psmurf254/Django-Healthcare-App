...
$(function () {
  ...
  var dt_category_table = $('.datatables-categorys'),
    select2 = $('.select2'),
    categoryView = '/app/category/view/account/',
    statusObj = {
  ...
  if (dt_category_table.length) {
    var dt_category = dt_category_table.DataTable({
      ...
      columnDefs: [
        ...
        {
          // category full name and email
          targets: 1,
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            var $name = full['category'],
              $image = full['avatar'];
            if ($image) {
              // For Avatar image
              var $output =
        ...
        //     var roleBadgeObj = {
        //       Subscriber:
        //         '<span class="badge badge-center rounded-pill bg-label-warning w-px-30 h-px-30 me-2"><i class="ti ti-category ti-sm"></i></span>',
        //       Author:
  ...
  // Delete Record
  $('.datatables-categorys tbody').on('click', '.delete-record', function () {
