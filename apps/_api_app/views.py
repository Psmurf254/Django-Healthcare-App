...
from .models import ApiData,ApiSms
...
def bot_post(request):#bot posts its data to be assessed
    ...
    #
    #     sdat=ApiSms(source =FSOURCE,date = formatted_date,time = formatted_time,message = FCONT,read = 'False')
    #     sdat.save()
    #
    ...
    #
    #
    #     smsdat=ApiSms(source =SENDER,date = formatted_date,time = formatted_time,message = MESS,read = 'False')
    #     smsdat.save()
    #
